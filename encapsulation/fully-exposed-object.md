...
- it is easy to use and easy for new JavaScript programmers to pick up quickly.

- unit testing, since all methods and attributes are publicly available.

## Drawbacks

- you cannot protect the internal data, and accessor and mutator methods add extra code that isn't strictly needed.
